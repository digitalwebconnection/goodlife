            ...
            <div className="flex gap-6">
              {[
                ...
                <a 
                  key={i} 
                  href="#" 
                  className="text-gray-500 hover:text-brand-yellow transition-all duration-300"
                >
                  {social.icon}
                </a>
              ))}
          ...
          <div data-aos="fade-up" data-aos-delay="100">
            ...
            <ul className="space-y-4">
              {['Home', 'About Us', 'Programs', 'Products', 'Blogs'].map(l => (
                <li key={l}>
                  <a href={`#${l.toLowerCase().replace(' ', '-')}`} className="text-gray-500 hover:text-brand-yellow transition-colors text-sm font-medium">
                    {l}
                  </a>
                </li>
              ))}
          ...
          <div data-aos="fade-up" data-aos-delay="200">
            ...
            <ul className="space-y-4">
              {['45-Day Detox', '90-Day Metabolic', '1-Year Transformation', 'Diabetes Care', 'PCOS Support'].map(l => (
                <li key={l}>
                  <a href="#plans" className="text-gray-500 hover:text-white transition-colors text-sm font-medium">
                    {l}
                  </a>
                </li>
              ))}
          ...
          <div data-aos="fade-up" data-aos-delay="300">
            ...
            <form className="flex flex-col gap-3">
              <input 
                ...
                className="w-full bg-white/[0.03] border border-white/10 rounded-none px-4 py-3 text-white text-sm outline-none focus:border-brand-yellow transition-all duration-300 font-jakarta placeholder:text-gray-700"
              />
              <button className="bg-brand-yellow hover:bg-white text-brand-black py-3 rounded-none transition-all duration-500 font-black text-[10px] uppercase tracking-widest">
                Join Now
              </button>
            </form>
          </div>
