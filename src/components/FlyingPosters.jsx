...
class Canvas {
  constructor({ container, canvas, items, planeWidth, planeHeight, distortion, scrollEase, cameraFov, cameraZ, autoSpeed }) {
    ...
    this.autoSpeed = autoSpeed != null ? autoSpeed : 0.3;
    this._rafId = null;
  ...
  update() {
    ...
    // Auto-advance the scroll target every frame
  ...
  addEventListeners() {
    // resize stays on window; interaction events scoped to container only
...
export default function FlyingPosters({
  ...
  }, [items, planeWidth, planeHeight, distortion, scrollEase, cameraFov, cameraZ, autoSpeed]);

  // No extra canvas-level wheel listeners needed — Canvas class handles it on container
