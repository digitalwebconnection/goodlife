...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative overflow-hidden bg-[#ffffff] py-10 lg:py-32">
      ...
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-brand-teal/10 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob" />
      <div className="absolute top-0 right-1/4 w-96 h-96 bg-brand-orange/5 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-2000" />
      <div className="absolute -bottom-32 left-1/2 w-96 h-96 bg-brand-lime/5 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-4000" />
          ...
          <div className="grid gap-16 lg:grid-cols-[1fr_1.1fr] lg:items-center">
            ...
            <div data-aos="fade-right" data-aos-duration="1000">
              ...
              <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
                ...
                >
                  <div className="absolute inset-0 w-full h-full bg-brand-orange transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-500" />
                  <span className="relative z-10 transition-colors duration-500 group-hover:text-white">Chat Now</span>
                  <span className="relative z-10 h-px w-6 bg-brand-orange transition-all duration-500 group-hover:bg-white group-hover:translate-x-2 group-hover:w-8" />
                </a>
                ...
                <div className="flex flex-col border-l-2 border-gray-200 pl-6">
                  ...
                  <a href="tel:+919979740361" className="font-playfair text-2xl font-bold text-[#191919] hover:text-brand-orange transition-colors duration-300">
                    +91 99797 40361
                  </a>
                </div>
              </div>
            ...
            >
              <div className="absolute -inset-1 bg-linear-to-r from-brand-orange/60 to-transparent  shadow-xl shadow-black  transition duration-1000 group-hover:duration-200" />
              ...
              <div className="relative border border-white/60 bg-white/80 backdrop-blur-xl p-8 shadow-[0_20px_60px_rgba(0,0,0,0.05)] sm:p-10">
                {sent ? (
                  <div className="flex min-h-[400px] flex-col items-center justify-center text-center animate-reveal">
                    <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-brand-orange shadow-[0_0_40px_rgba(254,133,67,0.4)] text-white scale-in-center">
                    ...
                    <button
                      ...
                      className="text-[10px] font-black uppercase tracking-[0.2em] text-[#191919] border-b-2 border-brand-orange pb-1 transition-all hover:text-gray-500 hover:border-gray-500"
                    >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6 relative">
                    <div className={`transition-all duration-300 ${focusedField === 'name' ? '-translate-y-1' : ''}`}>
                      ...
                      <input
                        ...
                        className="w-full rounded-md border bg-gray-50/50 px-5 py-4 text-sm text-gray-800 placeholder-gray-400 shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)] outline-none transition-all duration-300 focus:bg-white focus:ring-2 focus:ring-brand-orange/50 focus:shadow-[0_8px_30px_rgba(254,133,67,0.1)]"
                        value={form.name}
                    ...
                    >
                      <div className="absolute inset-0 w-full h-full bg-brand-orange transform scale-y-0 group-hover:scale-y-100 transition-transform origin-bottom duration-500" />
