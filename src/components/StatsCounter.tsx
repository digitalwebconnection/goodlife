...
export default function StatsCounter() {
  ...
  return (
    ...
    >
      {/* Subtle Light Background Composition */}
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-0 left-0 w-[80%] h-[80%] opacity-[0.05] blur-[150px]" 
             style={{ background: 'radial-gradient(ellipse at 20% 20%, rgba(255,193,7,1), transparent)' }} />
      </div>
      ...
      <div className="container-custom relative z-10">
        <div className="text-center mb-12">
          ...
          >
            ...
            <span className="text-brand-yellow italic font-normal">For Themselves</span>
          </h2>
          <div 
            data-aos="zoom-in" 
            data-aos-delay="200"
            className="w-20 h-[2px] bg-brand-yellow mx-auto mt-8 opacity-40"
          />
        </div>
