  ...
  return (
    <section className="relative py-16 lg:py-20 overflow-hidden bg-brand-black">
      ...
      <div className="container-custom relative z-10">
        ...
        >
          {/* Animated Glows */}
          <div className="absolute -top-40 -left-40 w-96 h-96 bg-[#FFC300] opacity-10 blur-[120px] rounded-full group-hover:scale-150 transition-transform duration-1000" />
          <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-[#FFC300] opacity-5 blur-[120px] rounded-full group-hover:scale-150 transition-transform duration-1000" />

          <div className="relative z-10">
            <p
              data-aos="fade-down"
              data-aos-delay="200"
              className="text-[#FFC300] font-black text-[10px] uppercase tracking-[0.6em] mb-10"
            >
            ...
            >
              🌱 Start Your<br />
              <span className="italic font-normal text-[#FFC300]">Health Journey</span>
            </h2>
            ...
            >
              <a
                ...
                className="ripple-btn group w-full sm:w-auto bg-[#FFC300] hover:bg-white text-brand-black font-black px-10 py-5 rounded-full text-xs uppercase tracking-[0.2em] transition-all duration-700 shadow-[0_15px_40px_rgba(255,193,7,0.2)] flex items-center justify-center gap-3 hover:scale-105"
              >
            ...
            <div className="mt-12 pt-8 border-t border-white/5 flex flex-wrap justify-center gap-x-8 gap-y-4 opacity-30">
              {['No Pills', 'No Gym', 'No Side Effects', 'Home Based'].map(t => (
                <div key={t} className="flex items-center gap-2">
                  <div className="w-1 h-1 rounded-full bg-[#FFC300]" />
