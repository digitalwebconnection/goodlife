  ...
  return (
    <section className="relative py-14 overflow-hidden bg-[#fffdf7]">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[700px] h-[700px] bg-brand-lime/10 blur-[140px] rounded-full" />
      </div>
    ...
    tracking-[0.25em] 
    uppercase
    shadow-[0_4px_20px_rgba(147,197,18,0.25)]
  ">
            ✨ Natural Healing
          </span>
          ...
          {CHALLENGES.map((item, i) => (
            ...
            >
              <ParticleCard
                ...
                clickEffect
                particleCount={14}
                glowColor={i % 4 === 0 ? "1, 180, 189" : i % 4 === 1 ? "254, 133, 67" : i % 4 === 2 ? "147, 197, 18" : "251, 173, 24"}
                className="
    group
    relative
    overflow-hidden
    ...
    shadow-black/40
    shadow-xl
    hover:shadow-[0_25px_20px_rgba(255,195,0,0.18)]
  "
              >
    ...
    "
      ...
      "
                  >
                    <div className={`w-8 h-8 ${i % 4 === 0 ? 'text-brand-teal' : i % 4 === 1 ? 'text-brand-orange' : i % 4 === 2 ? 'text-brand-lime' : 'text-brand-amber'}`}>
                      {item.icon}
                    </div>
                  </motion.div>
